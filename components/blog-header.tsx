      ...
      <div className="bg-zinc-900 border-b border-zinc-800 py-2 px-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-amber-500 transition-colors">
            ...
            <a href="mailto:barvaventuras@gmail.com" className="text-zinc-400 hover:text-amber-500 transition-colors">
